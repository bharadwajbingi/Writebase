  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-32 bg-primary/3">
      <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-gray-500/30 text-gray-500">
        <div>
          ...
          <p className="max-w-[410px] mt-6">
            ...
            facilis mollitia molestias facere vel magni consequatur placeat quam
            perspiciatis!
          </p>
        </div>
            ...
            <div key={index}>
              ...
              <ul className="text-sm space-y-1">
                {section.links.map((link, i) => (
                  <li key={i}>
                    <a href="http://" className="hover:underline transition">
                      {link}
                    </a>
                  </li>
                ))}
      ...
      <p className="py-4 text-center text-sm md:text-base text-gray-500/80">
        Copyright 2025 &copy; Writebase Bharadwaj - All Rights Reserved
      </p>
    </div>
  );
};
